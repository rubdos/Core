...
class YAFRAYPLUGIN_EXPORT photonIC_t: public mcIntegrator_t
{
	public:
		photonIC_t(unsigned int dPhotons, unsigned int cPhotons, bool transpShad=false, int shadowDepth = 4, float dsRad = 0.1f, float cRad = 0.01f);
		~photonIC_t();
